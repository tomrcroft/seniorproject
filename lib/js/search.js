...
$(document).ready(function() {
            ...
            success: function(response) {
               if(response.error == true) {
                  ...
                  for(i = 0; i < response.results.length; i++){
                     ...
                     '<div id="' + costumeID + '" class="inventory_item large-4 small-4 columns">' +
                        '<div class="panel_image panel clearfix" data-equalizer-watch>' +
                           '<img id="' + imageID + '" src="' + response.results[i].Costume_Image + '">' +
                        '</div>' +
                        '<div class="panel item_description clearfix">' +
            ...
            if(response.error == true) {
               ...
               for(i = 0; i < response.results.length; i++){
                  ...
                  '<div id="' + costumeID + '" class="inventory_item large-4 small-6 columns">' +
                     '<div class="panel_image panel clearfix centered" data-equalizer-watch>' +
                        '<img id="' + imageID + '" src="' + response.results[i].Costume_Image + '">' +
                     '</div>' +
   ...
   */
   ...
   $('#search_results').on("click", ".inventory_item .item_name", function() {
...
// Sad attempts at trying to get radio button to uncheck
      // $('.filter-facets').on("click", ":radio", function(event){
   // if($( this ).is('checked')){
...
// $ = jQuery;
// $('.filter-facets :radio').mousedown(function(e){
//   var $self = $(this);
//   if( $self.is(':checked') ){
