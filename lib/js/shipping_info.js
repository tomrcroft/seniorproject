...
$(document).ready(function() {
  $('#submit_info_button').click(function(e) {
      ...
      var shippingstate = $("#bshipping_state").val();
      ...
      if(billingname == "" || billingaddress == "" || billingcity == "" || billingstate == "" || billingzip == "" || billingcountry == "" ||
         ...
         contactproduction == "" || contactcode == "" || contactname == "" || contactemail == "" || contactphone == "" || contactfax == "" || paymenttype == "" || contactdescription == "" || contactsalesperson == "" || rentalfee == "") {
