...
$(document).ready(function() {
  $('#submit_production_info_button').click(function(e) {
      ...
      e.preventDefault();
      if(productionname == "" || deliverydate == "" || productionopendate == "" || productionclosedate == "" || dateofreturn == "" || notes == "") {
  ...
  $('#production_info').keyup(function(e){
    if(e.which == 13){//Enter key pressed
        $('#submit_production_info_button').click();//Trigger search button click event
    }
  });
